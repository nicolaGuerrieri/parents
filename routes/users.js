...
/***********************************************************************
 * console.log(nuovoEvento.cercaPostoNew);
 * console.log(nuovoEvento.localita);
 ...
 * console.log(nuovoEvento.ristoro);
 * console.log(nuovoEvento.attrezzatura);
 **********************************************************************/
...
router.post('/upload', upload.single('file'), function(req, res) {
	try {
		...
		console.log(nuovoEvento.localitasss);
	...
	/***************************************************************************
	 * var dirname = require('path').dirname(__dirname); var filename =
	 * req.file.originalname; var path = req.file.path; var type =
	 * req.file.mimetype;
	 * 
	 * var read_stream = fs.createReadStream(dirname + '/' + path);
	 * 
	 * var writestream = gfs.createWriteStream({ filename : filename });
	 * testNameFile = filename; read_stream.pipe(writestream);
	 * writestream.on('close', function(file) { id = file._id;
	 * console.log(file._id + 'Written To DB'); }); res.end(); } catch (err) {
	 * console.log(err); }
	 **************************************************************************/
